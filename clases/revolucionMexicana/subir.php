...
if(!empty($avance)){
    $avance = $avance +10;
    $sql1="UPDATE avance SET avance='$avance' WHERE id_usuario = $id_usuario AND id_tema='6'";

    mysqli_query( $conexion,$sql1);
    echo"----";
    
}else{
    $sql1="INSERT INTO avance (id_usuario,id_tema,avance) VALUES ('$id_usuario','6','10')";
